...
public class UserController{
	...
	public String addToCart(@RequestParam("productId") Integer productId,
		...
		if (productId == null) {
			redirectAttributes.addFlashAttribute("error", "РќРµС‚ ID С‚РѕРІР°СЂР°");
			return "redirect:/";
		}

		Product product = productService.getProduct(productId);
		if (product == null) {
			redirectAttributes.addFlashAttribute("error", "РўРѕРІР°СЂ РЅРµ РЅР°Р№РґРµРЅ");
			return "redirect:/";
		}


		System.out.println("Р”РѕР±Р°РІР»РµРЅ РІ РєРѕСЂР·РёРЅСѓ С‚РѕРІР°СЂ: " + product.getName() + " (ID: " + productId + ")");

		redirectAttributes.addFlashAttribute("success", product.getName() + " РґРѕР±Р°РІР»РµРЅ РІ РєРѕСЂР·РёРЅСѓ!");
		return "redirect:/";
	}
